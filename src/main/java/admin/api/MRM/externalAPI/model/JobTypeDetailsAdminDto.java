 ...
 * Job type details
 */
@ApiModel(description = "Job type details")

public class JobTypeDetailsAdminDto
{
  ...
  public JobTypeDetailsAdminDto allowedSubObjectTypeIds(List<Integer> allowedSubObjectTypeIds)
  {
  ...
  public JobTypeDetailsAdminDto addAllowedSubObjectTypeIdsItem(Integer allowedSubObjectTypeIdsItem)
  {
  ...
  public JobTypeDetailsAdminDto categoryIds(List<Integer> categoryIds)
  {
  ...
  public JobTypeDetailsAdminDto addCategoryIdsItem(Integer categoryIdsItem)
  {
  ...
  public JobTypeDetailsAdminDto defaultSubObjectTypeId(Integer defaultSubObjectTypeId)
  {
  ...
  public JobTypeDetailsAdminDto description(Map<String, String> description)
  {
  ...
  public JobTypeDetailsAdminDto putDescriptionItem(String key, String descriptionItem)
  {
  ...
  public JobTypeDetailsAdminDto forSubObjectsOnly(Boolean forSubObjectsOnly)
  {
  ...
  public JobTypeDetailsAdminDto groups(List<DseObjectTypeGroupDto> groups)
  {
  ...
  public JobTypeDetailsAdminDto addGroupsItem(DseObjectTypeGroupDto groupsItem)
  {
    if (this.groups == null)
    {
  ...
  public JobTypeDetailsAdminDto id(Integer id)
  {
  ...
  public JobTypeDetailsAdminDto mediaGuid(Integer mediaGuid)
  {
  ...
  public JobTypeDetailsAdminDto respectRestrictionByOrgUnits(Boolean respectRestrictionByOrgUnits)
  {
  ...
  public JobTypeDetailsAdminDto subObjectCanBeAddedManually(Boolean subObjectCanBeAddedManually)
  {
  ...
  public JobTypeDetailsAdminDto technicalName(String technicalName)
  {
  ...
  public JobTypeDetailsAdminDto topicId(Integer topicId)
  {
  ...
  public JobTypeDetailsAdminDto uniqueName(String uniqueName)
  {
  ...
  public JobTypeDetailsAdminDto name(Map<String, String> name)
  {
  ...
  public JobTypeDetailsAdminDto putNameItem(String key, String nameItem)
  {
    if (this.name == null)
    {
  ...
  public JobTypeDetailsAdminDto runModule(DseRunModuleEnum runModule)
  {
  ...
  public JobTypeDetailsAdminDto inheritanceType(DseInheritanceTypeEnum inheritanceType)
  {
  ...
  public JobTypeDetailsAdminDto parentJobTypeId(Integer parentJobTypeId)
  {
  ...
  public JobTypeDetailsAdminDto parentJobTypeName(String parentJobTypeName)
  {
  ...
  public boolean equals(Object o)
  {
    ...
    JobTypeDetailsAdminDto jobTypeDetailsAdminDto = (JobTypeDetailsAdminDto) o;
    return Objects.equals(this.allowedSubObjectTypeIds, jobTypeDetailsAdminDto.allowedSubObjectTypeIds) &&
            Objects.equals(this.categoryIds, jobTypeDetailsAdminDto.categoryIds) &&
            Objects.equals(this.defaultSubObjectTypeId, jobTypeDetailsAdminDto.defaultSubObjectTypeId) &&
            Objects.equals(this.description, jobTypeDetailsAdminDto.description) &&
            Objects.equals(this.forSubObjectsOnly, jobTypeDetailsAdminDto.forSubObjectsOnly) &&
            Objects.equals(this.groups, jobTypeDetailsAdminDto.groups) &&
            Objects.equals(this.id, jobTypeDetailsAdminDto.id) &&
            Objects.equals(this.mediaGuid, jobTypeDetailsAdminDto.mediaGuid) &&
            Objects.equals(this.respectRestrictionByOrgUnits, jobTypeDetailsAdminDto.respectRestrictionByOrgUnits) &&
            Objects.equals(this.subObjectCanBeAddedManually, jobTypeDetailsAdminDto.subObjectCanBeAddedManually) &&
            Objects.equals(this.technicalName, jobTypeDetailsAdminDto.technicalName) &&
            Objects.equals(this.topicId, jobTypeDetailsAdminDto.topicId) &&
            Objects.equals(this.uniqueName, jobTypeDetailsAdminDto.uniqueName) &&
            Objects.equals(this.name, jobTypeDetailsAdminDto.name) &&
            Objects.equals(this.runModule, jobTypeDetailsAdminDto.runModule) &&
            Objects.equals(this.inheritanceType, jobTypeDetailsAdminDto.inheritanceType) &&
            Objects.equals(this.parentJobTypeId, jobTypeDetailsAdminDto.parentJobTypeId) &&
            Objects.equals(this.parentJobTypeName, jobTypeDetailsAdminDto.parentJobTypeName);
  }

  @Override
  public int hashCode()
  {
    return Objects.hash(allowedSubObjectTypeIds, categoryIds, defaultSubObjectTypeId, description, forSubObjectsOnly, groups, id, mediaGuid, respectRestrictionByOrgUnits, subObjectCanBeAddedManually, technicalName, topicId, uniqueName, name, runModule, inheritanceType, parentJobTypeId, parentJobTypeName);
  }
  ...
  public String toString()
  {
    ...
    sb.append("class JobTypeDetailsAdminDto {\n");
