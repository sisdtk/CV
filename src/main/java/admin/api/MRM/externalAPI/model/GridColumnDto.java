 ...
 * DTO for grid row.
 */
@ApiModel(description = "DTO for grid row.")
...
public class GridColumnDto
{
  ...
  public GridColumnDto id(Integer id)
  {
  ...
  public GridColumnDto metaTypeId(Integer metaTypeId)
  {
  ...
  public GridColumnDto metaTypeName(String metaTypeName)
  {
  ...
  public GridColumnDto uniqueName(String uniqueName)
  {
  ...
  public GridColumnDto displayName(String displayName)
  {
  ...
  public GridColumnDto rawLabel(String rawLabel)
  {
  ...
  public GridColumnDto mode(Integer mode)
  {
  ...
  public GridColumnDto technicalName(String technicalName)
  {
  ...
  public GridColumnDto sharedLocale(Boolean sharedLocale)
  {
  ...
  public GridColumnDto helpText(String helpText)
  {
  ...
  public GridColumnDto visibility(VisibilityDto visibility)
  {
  ...
  public GridColumnDto dependsFromVariableId(Integer dependsFromVariableId)
  {
  ...
  public GridColumnDto dependsFromVariableValues(List<String> dependsFromVariableValues)
  {
  ...
  public GridColumnDto addDependsFromVariableValuesItem(String dependsFromVariableValuesItem)
  {
  ...
  public GridColumnDto typeSpanning(Boolean typeSpanning)
  {
  ...
  public GridColumnDto system(Boolean system)
  {
  ...
  public GridColumnDto storageType(Integer storageType)
  {
  ...
  public GridColumnDto position(Integer position)
  {
  ...
  public GridColumnDto variableTypeName(String variableTypeName)
  {
  ...
  public GridColumnDto dataSourceName(String dataSourceName)
  {
  ...
  public boolean equals(Object o)
  {
    ...
    return Objects.equals(this.id, gridColumnDto.id) &&
            Objects.equals(this.metaTypeId, gridColumnDto.metaTypeId) &&
            Objects.equals(this.metaTypeName, gridColumnDto.metaTypeName) &&
            Objects.equals(this.uniqueName, gridColumnDto.uniqueName) &&
            Objects.equals(this.displayName, gridColumnDto.displayName) &&
            Objects.equals(this.rawLabel, gridColumnDto.rawLabel) &&
            Objects.equals(this.mode, gridColumnDto.mode) &&
            Objects.equals(this.technicalName, gridColumnDto.technicalName) &&
            Objects.equals(this.sharedLocale, gridColumnDto.sharedLocale) &&
            Objects.equals(this.helpText, gridColumnDto.helpText) &&
            Objects.equals(this.visibility, gridColumnDto.visibility) &&
            Objects.equals(this.dependsFromVariableId, gridColumnDto.dependsFromVariableId) &&
            Objects.equals(this.dependsFromVariableValues, gridColumnDto.dependsFromVariableValues) &&
            Objects.equals(this.typeSpanning, gridColumnDto.typeSpanning) &&
            Objects.equals(this.system, gridColumnDto.system) &&
            Objects.equals(this.storageType, gridColumnDto.storageType) &&
            Objects.equals(this.position, gridColumnDto.position) &&
            Objects.equals(this.variableTypeName, gridColumnDto.variableTypeName) &&
            Objects.equals(this.dataSourceName, gridColumnDto.dataSourceName);
  }

  @Override
  public int hashCode()
  {
    return Objects.hash(id, metaTypeId, metaTypeName, uniqueName, displayName, rawLabel, mode, technicalName, sharedLocale, helpText, visibility, dependsFromVariableId, dependsFromVariableValues, typeSpanning, system, storageType, position, variableTypeName, dataSourceName);
  }
