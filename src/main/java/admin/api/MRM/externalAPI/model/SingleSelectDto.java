...
/**
 * DTO for SingleSelect variable type.
 */
@ApiModel(description = "DTO for SingleSelect variable type.")
...
public class SingleSelectDto
{
  ...
  public SingleSelectDto id(Integer id)
  {
  ...
  public SingleSelectDto metaTypeId(Integer metaTypeId)
  {
  ...
  public SingleSelectDto metaTypeName(String metaTypeName)
  {
  ...
  public SingleSelectDto uniqueName(String uniqueName)
  {
  ...
  public SingleSelectDto displayName(String displayName)
  {
  ...
  public SingleSelectDto rawLabel(String rawLabel)
  {
  ...
  public SingleSelectDto mode(Integer mode)
  {
  ...
  public SingleSelectDto technicalName(String technicalName)
  {
  ...
  public SingleSelectDto sharedLocale(Boolean sharedLocale)
  {
  ...
  public SingleSelectDto helpText(String helpText)
  {
  ...
  public SingleSelectDto visibility(VisibilityDto visibility)
  {
  ...
  public SingleSelectDto dependsFromVariableId(Integer dependsFromVariableId)
  {
  ...
  public SingleSelectDto dependsFromVariableValues(List<String> dependsFromVariableValues)
  {
  ...
  public SingleSelectDto addDependsFromVariableValuesItem(String dependsFromVariableValuesItem)
  {
  ...
  public SingleSelectDto typeSpanning(Boolean typeSpanning)
  {
  ...
  public SingleSelectDto system(Boolean system)
  {
  ...
  public SingleSelectDto storageType(Integer storageType)
  {
  ...
  public SingleSelectDto sourceCustomStructureName(String sourceCustomStructureName)
  {
  ...
  public SingleSelectDto style(String style)
  {
  ...
  public SingleSelectDto inheritFromParent(Boolean inheritFromParent)
  {
  ...
  public SingleSelectDto interdependentCheckBox(Boolean interdependentCheckBox)
  {
  ...
  public SingleSelectDto defaultValue(String defaultValue)
  {
  ...
  public SingleSelectDto interdependentVariableTechName(String interdependentVariableTechName)
  {
  ...
  public boolean equals(Object o)
  {
    ...
    SingleSelectDto singleSelectDto = (SingleSelectDto) o;
    return Objects.equals(this.id, singleSelectDto.id) &&
            Objects.equals(this.metaTypeId, singleSelectDto.metaTypeId) &&
            Objects.equals(this.metaTypeName, singleSelectDto.metaTypeName) &&
            Objects.equals(this.uniqueName, singleSelectDto.uniqueName) &&
            Objects.equals(this.displayName, singleSelectDto.displayName) &&
            Objects.equals(this.rawLabel, singleSelectDto.rawLabel) &&
            Objects.equals(this.mode, singleSelectDto.mode) &&
            Objects.equals(this.technicalName, singleSelectDto.technicalName) &&
            Objects.equals(this.sharedLocale, singleSelectDto.sharedLocale) &&
            Objects.equals(this.helpText, singleSelectDto.helpText) &&
            Objects.equals(this.visibility, singleSelectDto.visibility) &&
            Objects.equals(this.dependsFromVariableId, singleSelectDto.dependsFromVariableId) &&
            Objects.equals(this.dependsFromVariableValues, singleSelectDto.dependsFromVariableValues) &&
            Objects.equals(this.typeSpanning, singleSelectDto.typeSpanning) &&
            Objects.equals(this.system, singleSelectDto.system) &&
            Objects.equals(this.storageType, singleSelectDto.storageType) &&
            Objects.equals(this.sourceCustomStructureName, singleSelectDto.sourceCustomStructureName) &&
            Objects.equals(this.style, singleSelectDto.style) &&
            Objects.equals(this.inheritFromParent, singleSelectDto.inheritFromParent) &&
            Objects.equals(this.interdependentCheckBox, singleSelectDto.interdependentCheckBox) &&
            Objects.equals(this.defaultValue, singleSelectDto.defaultValue) &&
            Objects.equals(this.interdependentVariableTechName, singleSelectDto.interdependentVariableTechName);
  }

  @Override
  public int hashCode()
  {
    return Objects.hash(id, metaTypeId, metaTypeName, uniqueName, displayName, rawLabel, mode, technicalName, sharedLocale, helpText, visibility, dependsFromVariableId, dependsFromVariableValues, typeSpanning, system, storageType, sourceCustomStructureName, style, inheritFromParent, interdependentCheckBox, defaultValue, interdependentVariableTechName);
  }
  ...
  public String toString()
  {
    ...
    sb.append("class SingleSelectDto {\n");
