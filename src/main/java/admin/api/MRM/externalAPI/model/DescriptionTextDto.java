...
/**
 * DTO for description text variable type.
 */
@ApiModel(description = "DTO for description text variable type.")
...
public class DescriptionTextDto
{
  ...
  public DescriptionTextDto id(Integer id)
  {
  ...
  public DescriptionTextDto metaTypeId(Integer metaTypeId)
  {
  ...
  public DescriptionTextDto metaTypeName(String metaTypeName)
  {
  ...
  public DescriptionTextDto uniqueName(String uniqueName)
  {
  ...
  public DescriptionTextDto displayName(String displayName)
  {
  ...
  public DescriptionTextDto rawLabel(String rawLabel)
  {
  ...
  public DescriptionTextDto mode(Integer mode)
  {
  ...
  public DescriptionTextDto technicalName(String technicalName)
  {
  ...
  public DescriptionTextDto sharedLocale(Boolean sharedLocale)
  {
  ...
  public DescriptionTextDto helpText(String helpText)
  {
  ...
  public DescriptionTextDto visibility(VisibilityDto visibility)
  {
  ...
  public DescriptionTextDto dependsFromVariableId(Integer dependsFromVariableId)
  {
  ...
  public DescriptionTextDto dependsFromVariableValues(List<String> dependsFromVariableValues)
  {
  ...
  public DescriptionTextDto addDependsFromVariableValuesItem(String dependsFromVariableValuesItem)
  {
  ...
  public DescriptionTextDto typeSpanning(Boolean typeSpanning)
  {
  ...
  public DescriptionTextDto system(Boolean system)
  {
  ...
  public DescriptionTextDto storageType(Integer storageType)
  {
  ...
  public DescriptionTextDto text(String text)
  {
  ...
  public boolean equals(Object o)
  {
    ...
    DescriptionTextDto descriptionTextDto = (DescriptionTextDto) o;
    return Objects.equals(this.id, descriptionTextDto.id) &&
            Objects.equals(this.metaTypeId, descriptionTextDto.metaTypeId) &&
            Objects.equals(this.metaTypeName, descriptionTextDto.metaTypeName) &&
            Objects.equals(this.uniqueName, descriptionTextDto.uniqueName) &&
            Objects.equals(this.displayName, descriptionTextDto.displayName) &&
            Objects.equals(this.rawLabel, descriptionTextDto.rawLabel) &&
            Objects.equals(this.mode, descriptionTextDto.mode) &&
            Objects.equals(this.technicalName, descriptionTextDto.technicalName) &&
            Objects.equals(this.sharedLocale, descriptionTextDto.sharedLocale) &&
            Objects.equals(this.helpText, descriptionTextDto.helpText) &&
            Objects.equals(this.visibility, descriptionTextDto.visibility) &&
            Objects.equals(this.dependsFromVariableId, descriptionTextDto.dependsFromVariableId) &&
            Objects.equals(this.dependsFromVariableValues, descriptionTextDto.dependsFromVariableValues) &&
            Objects.equals(this.typeSpanning, descriptionTextDto.typeSpanning) &&
            Objects.equals(this.system, descriptionTextDto.system) &&
            Objects.equals(this.storageType, descriptionTextDto.storageType) &&
            Objects.equals(this.text, descriptionTextDto.text);
  }

  @Override
  public int hashCode()
  {
    return Objects.hash(id, metaTypeId, metaTypeName, uniqueName, displayName, rawLabel, mode, technicalName, sharedLocale, helpText, visibility, dependsFromVariableId, dependsFromVariableValues, typeSpanning, system, storageType, text);
  }
  ...
  public String toString()
  {
    ...
    sb.append("class DescriptionTextDto {\n");
