...
/**
 * DTO for RelationColumn variable type.
 */
@ApiModel(description = "DTO for RelationColumn variable type.")

public class RelationColumnDto
{
  ...
  public RelationColumnDto id(Integer id)
  {
  ...
  public RelationColumnDto metaTypeId(Integer metaTypeId)
  {
  ...
  public RelationColumnDto metaTypeName(String metaTypeName)
  {
  ...
  public RelationColumnDto uniqueName(String uniqueName)
  {
  ...
  public RelationColumnDto displayName(String displayName)
  {
  ...
  public RelationColumnDto rawLabel(String rawLabel)
  {
  ...
  public RelationColumnDto mode(Integer mode)
  {
  ...
  public RelationColumnDto technicalName(String technicalName)
  {
  ...
  public RelationColumnDto sharedLocale(Boolean sharedLocale)
  {
  ...
  public RelationColumnDto helpText(String helpText)
  {
  ...
  public RelationColumnDto visibility(VisibilityDto visibility)
  {
  ...
  public RelationColumnDto dependsFromVariableId(Integer dependsFromVariableId)
  {
  ...
  public RelationColumnDto dependsFromVariableValues(List<String> dependsFromVariableValues)
  {
  ...
  public RelationColumnDto addDependsFromVariableValuesItem(String dependsFromVariableValuesItem)
  {
  ...
  public RelationColumnDto typeSpanning(Boolean typeSpanning)
  {
  ...
  public RelationColumnDto system(Boolean system)
  {
  ...
  public RelationColumnDto storageType(Integer storageType)
  {
  ...
  public RelationColumnDto width(Integer width)
  {
  ...
  public RelationColumnDto position(Integer position)
  {
  ...
  public RelationColumnDto moduleId(Integer moduleId)
  {
  ...
  public RelationColumnDto typeIds(List<String> typeIds)
  {
  ...
  public RelationColumnDto addTypeIdsItem(String typeIdsItem)
  {
  ...
  public RelationColumnDto formerTechnicalValue(String formerTechnicalValue)
  {
  ...
  public RelationColumnDto dynamicTableIndex(String dynamicTableIndex)
  {
  ...
  public boolean equals(Object o)
  {
    ...
    RelationColumnDto relationColumnDto = (RelationColumnDto) o;
    return Objects.equals(this.id, relationColumnDto.id) &&
            Objects.equals(this.metaTypeId, relationColumnDto.metaTypeId) &&
            Objects.equals(this.metaTypeName, relationColumnDto.metaTypeName) &&
            Objects.equals(this.uniqueName, relationColumnDto.uniqueName) &&
            Objects.equals(this.displayName, relationColumnDto.displayName) &&
            Objects.equals(this.rawLabel, relationColumnDto.rawLabel) &&
            Objects.equals(this.mode, relationColumnDto.mode) &&
            Objects.equals(this.technicalName, relationColumnDto.technicalName) &&
            Objects.equals(this.sharedLocale, relationColumnDto.sharedLocale) &&
            Objects.equals(this.helpText, relationColumnDto.helpText) &&
            Objects.equals(this.visibility, relationColumnDto.visibility) &&
            Objects.equals(this.dependsFromVariableId, relationColumnDto.dependsFromVariableId) &&
            Objects.equals(this.dependsFromVariableValues, relationColumnDto.dependsFromVariableValues) &&
            Objects.equals(this.typeSpanning, relationColumnDto.typeSpanning) &&
            Objects.equals(this.system, relationColumnDto.system) &&
            Objects.equals(this.storageType, relationColumnDto.storageType) &&
            Objects.equals(this.width, relationColumnDto.width) &&
            Objects.equals(this.position, relationColumnDto.position) &&
            Objects.equals(this.moduleId, relationColumnDto.moduleId) &&
            Objects.equals(this.typeIds, relationColumnDto.typeIds) &&
            Objects.equals(this.formerTechnicalValue, relationColumnDto.formerTechnicalValue) &&
            Objects.equals(this.dynamicTableIndex, relationColumnDto.dynamicTableIndex);
  }

  @Override
  public int hashCode()
  {
    return Objects.hash(id, metaTypeId, metaTypeName, uniqueName, displayName, rawLabel, mode, technicalName, sharedLocale, helpText, visibility, dependsFromVariableId, dependsFromVariableValues, typeSpanning, system, storageType, width, position, moduleId, typeIds, formerTechnicalValue, dynamicTableIndex);
  }
  ...
  public String toString()
  {
    ...
    sb.append("class RelationColumnDto {\n");
