...
public class ActionButtonDto
{
  ...
  public ActionButtonDto id(Integer id)
  {
  ...
  public ActionButtonDto metaTypeId(Integer metaTypeId)
  {
  ...
  public ActionButtonDto metaTypeName(String metaTypeName)
  {
  ...
  public ActionButtonDto uniqueName(String uniqueName)
  {
  ...
  public ActionButtonDto displayName(String displayName)
  {
  ...
  public ActionButtonDto rawLabel(String rawLabel)
  {
  ...
  public ActionButtonDto mode(Integer mode)
  {
  ...
  public ActionButtonDto technicalName(String technicalName)
  {
  ...
  public ActionButtonDto sharedLocale(Boolean sharedLocale)
  {
  ...
  public ActionButtonDto helpText(String helpText)
  {
  ...
  public ActionButtonDto visibility(VisibilityDto visibility)
  {
  ...
  public ActionButtonDto dependsFromVariableId(Integer dependsFromVariableId)
  {
  ...
  public ActionButtonDto dependsFromVariableValues(List<String> dependsFromVariableValues)
  {
  ...
  public ActionButtonDto addDependsFromVariableValuesItem(String dependsFromVariableValuesItem)
  {
  ...
  public ActionButtonDto typeSpanning(Boolean typeSpanning)
  {
  ...
  public ActionButtonDto system(Boolean system)
  {
  ...
  public ActionButtonDto storageType(Integer storageType)
  {
  ...
  public ActionButtonDto url(String url)
  {
  ...
  public boolean equals(Object o)
  {
    ...
    ActionButtonDto actionButtonDto = (ActionButtonDto) o;
    return Objects.equals(this.id, actionButtonDto.id) &&
            Objects.equals(this.metaTypeId, actionButtonDto.metaTypeId) &&
            Objects.equals(this.metaTypeName, actionButtonDto.metaTypeName) &&
            Objects.equals(this.uniqueName, actionButtonDto.uniqueName) &&
            Objects.equals(this.displayName, actionButtonDto.displayName) &&
            Objects.equals(this.rawLabel, actionButtonDto.rawLabel) &&
            Objects.equals(this.mode, actionButtonDto.mode) &&
            Objects.equals(this.technicalName, actionButtonDto.technicalName) &&
            Objects.equals(this.sharedLocale, actionButtonDto.sharedLocale) &&
            Objects.equals(this.helpText, actionButtonDto.helpText) &&
            Objects.equals(this.visibility, actionButtonDto.visibility) &&
            Objects.equals(this.dependsFromVariableId, actionButtonDto.dependsFromVariableId) &&
            Objects.equals(this.dependsFromVariableValues, actionButtonDto.dependsFromVariableValues) &&
            Objects.equals(this.typeSpanning, actionButtonDto.typeSpanning) &&
            Objects.equals(this.system, actionButtonDto.system) &&
            Objects.equals(this.storageType, actionButtonDto.storageType) &&
            Objects.equals(this.url, actionButtonDto.url);
  }

  @Override
  public int hashCode()
  {
    return Objects.hash(id, metaTypeId, metaTypeName, uniqueName, displayName, rawLabel, mode, technicalName, sharedLocale, helpText, visibility, dependsFromVariableId, dependsFromVariableValues, typeSpanning, system, storageType, url);
  }
  ...
  public String toString()
  {
    ...
    sb.append("class ActionButtonDto {\n");
